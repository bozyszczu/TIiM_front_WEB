...
class UpdateClub extends Component {
    ...
    updateClub = (c) => {
        ...
        ClubService.updateClub(club, this.state.id).then(res => {
    ...
    render() {
        return (
            <Card style={{ margin: "10px" }}>
                <Card.Title>Update Club</Card.Title>
                <Card.Body>
                    <Form className='w-50'>
                        <Form.Group>
                        ...
                        <Button variant='success' className='w-50' style={{ margin: "10px" }} onClick={this.updateClub}>Save</Button>
